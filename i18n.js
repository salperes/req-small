const translations = {
  en: {
    ...
    "csv.header.subsystem": "Subsystem",
    ...
    "status.selectCsvFile": "Select a CSV file first.",
  ...
  tr: {
    ...
    "status.selectCsvFile": "Önce bir CSV dosyası seçin.",
    ...
    "csv.header.subsystem": "Alt Sistem",
